...
For the current Codex image-first approval workflow, read `references/character-studio.md`
and `tools/character_studio_web/README.md`. The user's current preference is ChatGPT image
generation plus Aseprite, with PixelLab optional; this supersedes PixelLab-first guidance below.
