...
func capture(label:String):
	...
	root.get_texture().get_image().save_png("C:/Cravera/art/forest-pass4/shadows-"+label+".png")
func run():
	...
	world._spawn_prop(Vector2i(0,2),"workbench")
	world._spawn_prop(Vector2i(-4,1),"hide_bed")
