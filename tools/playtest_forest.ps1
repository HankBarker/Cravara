param([switch]$FreshPreview, [switch]$ArmorPreview, [switch]$DinoPreview, [switch]$FolkPreview, [switch]$IntroPreview)
...
if ($FreshPreview -or $ArmorPreview -or $DinoPreview -or $FolkPreview -or $IntroPreview) { $launchArguments += @('res://Forest/ForestPlaytest.tscn', '--', '--no-save-playtest') }
