param([switch]$FreshPreview, [switch]$ArmorPreview, [switch]$DinoPreview, [switch]$FolkPreview, [switch]$IntroPreview, [switch]$WildsPreview)
...
if ($FreshPreview -or $ArmorPreview -or $DinoPreview -or $FolkPreview -or $IntroPreview -or $WildsPreview) { $launchArguments += @('res://Forest/ForestPlaytest.tscn', '--', '--no-save-playtest') }
