param([switch]$FreshPreview, [switch]$ArmorPreview, [switch]$DinoPreview, [switch]$FolkPreview)
...
if ($FreshPreview -or $ArmorPreview -or $DinoPreview -or $FolkPreview) { $launchArguments += @('res://Forest/ForestPlaytest.tscn', '--', '--no-save-playtest') }
