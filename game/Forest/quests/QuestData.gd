...
const QUESTS := [
	...
	{"id": "guide_glassmere", "giver": "guide", "title": "The water to the {dir:glassmere}", "needs": "region:glassmere",
		"ask": "{Dir:glassmere} of here the land sinks into the Mirefen: bog and black water, and at its heart a mere as deep as a well. Go and see it, and mind what swims there.",
	...
	{"id": "trader_cactus", "giver": "trader", "title": "Fruit of the dunes", "needs": "item:cactus_fruit",
		"ask": "Out in the dunes to the {dir:dunes} the cacti fruit red as embers. Sweet as honey, and nobody sells them. Five, please.",
